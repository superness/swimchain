...
pub enum TestError {
    ...
    NodeStart { node_index: usize, message: String },
    ...
    AllConnectionsTimeout { timeout_secs: u64 },
    ...
    Shutdown { node_index: usize, message: String },
    ...
    /// Sync failed
    SyncFailed { node_index: usize, message: String },
    /// Content propagation failed
    PropagationFailed { message: String },
...
impl fmt::Display for TestError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            TestError::ConditionTimeout {
                condition,
                timeout_secs,
            } => {
                write!(
                    f,
                    "Condition '{}' not met after {}s",
                    condition, timeout_secs
                )
            }
        }
    }
