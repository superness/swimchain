/**
 * Identity page for archiver-client
  ...
  return (
    <div className="identity-page">
      ...
      <div className="identity-page__info">
        <p>
          This identity is managed by your Swimchain node. The archiver client uses it
          for authenticated operations like content engagement.
        </p>
      </div>
    </div>
  );
