...
/** PoW difficulty for reactions - per SPEC_03 (mainnet: 16) */
export const REACTION_DIFFICULTY = 16;

/** PoW difficulty for messages - per SPEC_03 (mainnet: 18) */
export const MESSAGE_DIFFICULTY = 18;
