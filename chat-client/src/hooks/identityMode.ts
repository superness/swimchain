/**
 * Pure identity-mode selection for chat-client.
 *
 * Kept free of any React / SDK / WASM imports so it can be unit-tested in
 * isolation and reused by {@link ./useChatIdentity}.
 */

/** Which identity source chat should use. */
...
/**
 * Decide whether chat adopts the node identity or the browser keypair.
 *
