...
return<div className="dm-panel"><div className="dm-panel-header" onClick={()=>setC(!c)} role="button" tabIndex={0}><span>Direct Messages{totalUnread>0&&<span className="dm-unread-badge">{totalUnread}</span>}</span><span className={'dm-chevron'+(c?' collapsed':'')}>▾</span></div>
