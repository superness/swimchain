...
interface MediaRef {
  mediaHash: string;
  mediaType: string;
  url?: string; // Pre-loaded URL if available
  sizeBytes?: number;
}

interface ImageGalleryProps {
  mediaRefs: MediaRef[];
  /** Show as small thumbnails (for message list) */
...
/**
 * Simple thumbnail indicator for message list
 * Shows a small icon indicating the message has images
 */
