...
{
  const s: ChipsState = {
    crumbs: 1_000_000_000, lifetimeChips: 0, oldSalt: 0, tips: 0, broken: 0, deepest: 0, char: 0, bowls: 0, paidToBosses: 0, bossDamage: 0, charOwned: new Set(), declined: new Set(), crispest: 0, owned: new Set(['airtight']),
...
//    as the fold's `sogNum`. Guacamole rots faster (96) than Plain Salsa (97).
{
  const base = (dipIndex: number, airtight: boolean): ChipsState => ({
    crumbs: START_BOWL_CAP, lifetimeChips: 0, oldSalt: 0, tips: 0, broken: 0, deepest: 0, char: 0, bowls: 0, paidToBosses: 0, bossDamage: 0, charOwned: new Set(), declined: new Set(), crispest: 0, owned: new Set(),
...
{
  const s: ChipsState = {
    crumbs: 10_000, lifetimeChips: 0, oldSalt: 0, tips: 0, broken: 0, deepest: 0, char: 0, bowls: 0, paidToBosses: 0, bossDamage: 0, charOwned: new Set(), declined: new Set(), crispest: 0, owned: new Set(),
    bowlCap: START_BOWL_CAP, seasoningNum: 1, seasoningDen: 1, fryers: 1,
