...
const baseState = (over: Partial<ChipsState> = {}): ChipsState => ({
  crumbs: 0, lifetimeChips: 0, oldSalt: 0, tips: 0, broken: 0, deepest: 0, char: 0, bowls: 0, paidToBosses: 0, bossDamage: 0, bossHpFrozen: 0, charOwned: new Set(), declined: new Set(), crispest: 0, owned: new Set(),
