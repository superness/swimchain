 ...
 * Uses JSON serialization to avoid separator collision issues
 */
export async function encryptPost(
  ...
  // Use JSON serialization to avoid separator collision (e.g., body containing "\n\n")
  const fullContent = JSON.stringify({ title, body });
...
export async function encryptPrivatePost(
  ...
  // Use JSON serialization to avoid separator collision
  const fullContent = JSON.stringify({ title, body });
