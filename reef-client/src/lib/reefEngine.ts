...
export async function loadRegion(rpc: SwimchainRpc, regionId: string): Promise<ReefState> {
  ...
  // limit: the node's default is 1000 — a reef region outgrows that within days
  // of bot play, and every move past the cap silently vanished from the fold
  // (the 2026-07-16 "board wipe": sealed moves invisible, cells reaped).
