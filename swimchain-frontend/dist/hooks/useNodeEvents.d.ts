 ...
 * ```
 */
import { type EventsConnectionStatus, type NodeEvent, type NodeEventType } from '../lib/events';
...
export declare function useNodeEvents(options: UseNodeEventsOptions): UseNodeEventsResult;
//# sourceMappingURL=useNodeEvents.d.ts.map