 ...
 */
export function getDMSpaceId(myPk, theirPk) {
 ...
 */
export function isDMSpace(spaceId, pk1, pk2) {
 ...
 */
export function getDMSpaceName(myPk, theirPk) {
 ...
 */
export function canInitiateDM(status) {
    return status === 'none' || status === 'declined';
}
/**
 * Get display text for DM status
 */
export function getDMStatusText(status) {
    switch (status) {
        case 'none':
            return 'Message';
        case 'pending_sent':
 ...
 */
export function getDMAction(status) {
    switch (status) {
        case 'none':
        case 'declined':
            return 'send_request';
