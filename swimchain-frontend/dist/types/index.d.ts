...
export declare const POOL_TARGET_SECONDS = 60;
/** Quick engagement contribution in seconds */
export declare const ENGAGE_QUICK_SECONDS = 5;
/** Standard engagement contribution in seconds */
export declare const ENGAGE_STANDARD_SECONDS = 15;
...
export declare const TYPING_BROADCAST_INTERVAL_MS = 3000;
...
export declare const PRESENCE_AWAY_THRESHOLD_MS = 120000;
...
export declare const HEAT_UPDATE_INTERVAL_MS = 60000;
/** PoW difficulty for reactions (~1s on mobile, <1s on desktop) */
export declare const REACTION_DIFFICULTY = 8;
/** PoW difficulty for messages (~15s on desktop) */
export declare const MESSAGE_DIFFICULTY = 10;
/**
 ...
 */
export declare function getHeatState(heatPercent: number): HeatState;
/**
 * Get CSS class for heat-based opacity
 */
export declare function getHeatClass(heatPercent: number): string;
/**
